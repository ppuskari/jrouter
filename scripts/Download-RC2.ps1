param(
    [long]$RunId = 0,
    [string]$Destination = ".\build\v1.0.0-rc2"
)

$ErrorActionPreference = "Stop"

$branch = "petar/aurp-v1.0.0-rc2-prep-20260902"
$workflow = "AURP v1.0.0-rc2"
$artifact = "jrouter-v1.0.0-rc2-linux-amd64"
...
$binary = Join-Path $Destination "jrouter-v1.0.0-rc2-linux-amd64"
$shaFile = Join-Path $Destination "jrouter-v1.0.0-rc2-linux-amd64.sha256"
...
$expectedVersion = "jrouter v1.0.0-rc2 build $headSha"
...
Write-Host "=== JROUTER v1.0.0-rc2 ARTIFACT READY ==="
